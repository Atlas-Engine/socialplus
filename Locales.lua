...
L.GROUP_BULK_WRITING      = "Updating %d friends. Battle.net applies these one at a time, so it may take a moment."
...
L.SETTING_SECTION_DISPLAY    = "Display"
L.SETTING_SECTION_PVP        = "PvP"
...
L.WOW_ONLINE_NO_DETAILS     = "World of Warcraft"
...
if locale == "frFR" then
    ...
    L.GROUP_BULK_WRITING      = "Mise a jour de %d amis. Battle.net les applique un par un, cela peut donc prendre un moment."
...
elseif locale == "esES" or locale == "esMX" then
    ...
    L.GROUP_BULK_WRITING      = "Actualizando %d amigos. Battle.net los aplica de uno en uno, asi que puede tardar un momento."
